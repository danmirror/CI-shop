              ...
              <ul class="aa-product-catg">
                ...
                <li>
                  <figure>
                    ...
                    <a class="aa-add-card-btn" href="<?php echo site_url().'/cart/add?id='.$p->kode;?>"> <span class="fa fa-shopping-cart"></span>Add To Cart</a>
                    <figcaption>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="aa-product-view-content">
                            ...
                            <div class="aa-prod-view-bottom">
                              <a href="<?php echo site_url().'/Cart/add?id='.$p->kode;?>" class="aa-add-to-cart-btn"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
